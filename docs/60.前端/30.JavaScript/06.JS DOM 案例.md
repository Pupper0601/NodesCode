    ...
    <style>
        * {
        ...
        .demo ul li i {
            ...
            width: 24px;
            height: 24px;
            background: url(https://pupper.com.cn/img/202112101140615.png) no-repeat 0 0;
        }
    </style>
</head>
...
<head>
    ...
    <style>
        ...
        .message {
            ...
            font-size: 12px;
            color: #999;
            background: url(https://pupper.com.cn/img/202112101459674.png) no-repeat left center;
            padding-left: 20px;
        }
        
        .wrong {
            color: red;
            background-image: url(https://pupper.com.cn/img/202112101116909.png);
        }
        
        .right {
            color: green;
            background-image: url(https://pupper.com.cn/img/202112101459932.png);
        }
    </style>
</head>
...
<head>
    ...
    <style>
        * {
        ...
        body {
            background: url(https://pupper.com.cn/img/202112101605471.jpg) ;
...
<body>
    <div class="demo">
        <div class="box">
            <img src="https://pupper.com.cn/img/202112101605471.jpg" alt=""><img
                src="https://pupper.com.cn/img/202112101605097.jpg" alt=""><img
                src="https://pupper.com.cn/img/202112101605182.jpg" alt=""><img
                src="https://pupper.com.cn/img/202112101606060.jpg" alt="">
        </div>
    </div>
